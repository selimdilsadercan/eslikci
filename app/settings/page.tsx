          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white/80 dark:bg-[var(--card-background)] rounded-2xl p-4 border border-gray-200 dark:border-[var(--card-border)] shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium ${currentUser.isOnboardingFinished ? "text-green-600 dark:text-green-400" : "text-orange-600 dark:text-orange-400"}`}
                    >
                      {currentUser.isOnboardingFinished
                        ? "Tamamlandı"
                        : "Tamamlanmadı"}
                    </span>
                  </div>
              ...
              <div className="bg-white/80 dark:bg-[var(--card-background)] rounded-2xl p-4 border border-gray-200 dark:border-[var(--card-border)] shadow-sm">
                <button
                  onClick={() => router.back()}
                  className="w-full flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[var(--card-background)] rounded-lg p-2 transition-colors"
                >
                  <ArrowLeft size={20} />
