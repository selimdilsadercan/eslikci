          ...
          <div className="max-w-sm mx-auto">
                  ...
                  <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-blue-500 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-2xl font-bold text-white">
                      {currentUserAsPlayer.initial ||
                        currentUserAsPlayer.name?.charAt(0).toUpperCase() ||
                        "U"}
                    </span>
                  </div>
                )}
              </div>
              <h2 className="text-2xl font-bold text-gray-800 dark:text-[var(--foreground)] mb-1">
                {!currentUserAsPlayer ? (
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white/80 dark:bg-[var(--card-background)] rounded-2xl p-4 border border-gray-200 dark:border-[var(--card-border)] shadow-sm">
                <Link
                  href="/pro"
                  className="flex items-center gap-3 text-gray-700 dark:text-[var(--foreground)]"
                >
                  <div
              ...
              {isAdmin && (
                <div className="bg-white/80 dark:bg-[var(--card-background)] rounded-2xl p-4 border border-gray-200 dark:border-[var(--card-border)] shadow-sm">
                  <button
                    ...
                    className="w-full flex items-center gap-3 text-gray-700 dark:text-[var(--foreground)]"
                  >
              ...
              <div className="bg-white/80 dark:bg-[var(--card-background)] rounded-2xl p-4 border border-gray-200 dark:border-[var(--card-border)] shadow-sm">
                <button
                  ...
                  className="w-full flex items-center gap-3 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors"
                >
