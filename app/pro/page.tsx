...
export default function ProPage() {
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[var(--background)]">
        <div className="pt-20 px-4">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-[var(--foreground)] mb-4">Pro Features</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-8">Please sign in to access Pro features</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[var(--background)] pb-20 lg:pb-0">
      {/* Header with Back Button */}
      <div className="sticky top-0 z-10 bg-gray-50 dark:bg-[var(--background)] pt-4 pb-2 px-4">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-gray-900 dark:text-[var(--foreground)]">Pro Features</h1>
      ...
      <div className="pt-4 pb-20">
        <div className="px-4 max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-[var(--foreground)] mb-2">Pro Features</h2>
          ...
          <div className="space-y-4 mb-8">
            {proFeatures.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-[var(--card-background)] rounded-xl p-4 shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 mt-1">
                    {feature.icon}
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 dark:text-[var(--foreground)] mb-1">{feature.title}</h3>
                    ...
                    <div className="flex items-center space-x-2">
                      {isPro ? (
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400">{feature.benefit}</span>
                      )}
                    </div>
                  </div>
                </div>
          ...
          {/* Pro Benefits */}
          <div className="bg-white dark:bg-[var(--card-background)] rounded-xl p-6 shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700">
            <h3 className="font-semibold text-gray-900 dark:text-[var(--foreground)] mb-4">Why Upgrade to Pro?</h3>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Support the development of Eşlikçi</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Enjoy a distraction-free gaming experience</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                <span className="text-sm text-gray-700 dark:text-gray-300">Get early access to new features</span>
              </div>
            </div>
          </div>
      ...
      {showCancelConfirm && (
        ...
        >
          <div 
            className="w-full max-w-md bg-white dark:bg-[var(--card-background)] rounded-2xl shadow-xl overflow-hidden"
          ...
          >
            <div className="p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-[var(--foreground)] text-center mb-2">
                Cancel Pro Subscription
              </h3>
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => setShowCancelConfirm(false)}
                  disabled={isCancelling}
                  className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 py-3 px-4 rounded-xl font-semibold hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                >
                  Keep Pro
                </button>
              </div>
