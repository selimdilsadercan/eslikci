  ...
  return (
    <>
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:z-50 lg:bg-white dark:bg-[var(--card-background)] lg:border-r lg:border-gray-200 dark:border-[var(--card-border)]">
        {/* Sidebar Header */}
        <div className="flex items-center px-6 py-4 border-b border-gray-200 dark:border-[var(--card-border)]">
        ...
        <div className="fixed inset-0 bg-[#00000090] flex items-center justify-center z-50">
          <div className="bg-white dark:bg-[var(--card-background)] rounded-2xl p-6 mx-4 max-w-sm w-full">
            <div className="text-center">
              <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 dark:bg-[var(--card-background)] mb-4">
                <svg
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-[var(--card-border)] rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[var(--card-background)] transition-colors"
                >
                  İptal
                </button>
                <button
