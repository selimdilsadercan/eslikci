...
import { Plus, Minus, Gear, CrownSimple, Trash, ArrowCounterClockwise, X } from '@phosphor-icons/react';
...
interface BottomInputAreaProps {
  ...
  setCurrentScores: React.Dispatch<React.SetStateAction<{[key: string]: number}>>;
  multipleScores: {[key: string]: number[]};
  setMultipleScores: React.Dispatch<React.SetStateAction<{[key: string]: number[]}>>;
  crownWinners: {[key: string]: boolean};
  setCrownWinners: React.Dispatch<React.SetStateAction<{[key: string]: boolean}>>;
  ...
  addScoreInput: (playerId: Id<'players'>) => void;
  removeScoreInput: (playerId: Id<'players'>) => void;
  updateMultipleScore: (playerId: Id<'players'>, index: number, value: number) => void;
  toggleCrown: (playerId: Id<'players'>) => void;
  undoLastRound: () => void;
  resetAllRounds: () => void;
  toggleHideTotalColumn: () => void;
  endRound: () => void;
  getNextRoundNumber: () => number;
  handleConfirmAction: (action: () => void, config: {
    title: string;
    message: string;
    confirmText: string;
    isDestructive: boolean;
